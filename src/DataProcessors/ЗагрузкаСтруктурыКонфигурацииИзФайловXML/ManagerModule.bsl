...
Процедура кфкЗагрузитьОбъектМетаданных(ОбщиеПеременные, ТекущийРодитель, ВложенныйФайл, ПрефиксИменЭлементов, ТипОбъекта)
...
Процедура кфкПрочитатьСведенияОСвойствахИзXML(ЧтениеXML, ДанныеОбъекта, ОбщиеПеременные)
		...
		Пока ЧтениеXML.Прочитать() Цикл
			Если ЧтениеXML.ТипУзла = ТипУзлаXML.НачалоЭлемента Тогда
				...
				ИначеЕсли ЧтениеXML.Имя = "Attribute"
					...
					Или (ЧтениеXML.Имя = "AccountingFlag" И ДанныеОбъекта.ТипОбъекта <> Перечисления.ТипыОбъектов.РегистрБухгалтерии)
					ИЛИ ЧтениеXML.Имя = "AddressingAttribute"
					Тогда
					...
					Если ЧтениеXML.Имя = "Attribute" Или ЧтениеXML.Имя = "AccountingFlag" Тогда
						...
						КонецЕсли;
					ИначеЕсли ЧтениеXML.Имя = "AddressingAttribute" Тогда
						ТекСвойство.Вид = Перечисления.ВидыСвойств.РеквизитАдресации;
			...
			ИначеЕсли ЧтениеXML.ТипУзла = ТипУзлаXML.КонецЭлемента Тогда
				Если ЧтениеXML.Имя = "Attribute" Или ЧтениеXML.Имя = "Dimension"
					Или ЧтениеXML.Имя = "Resource" 
					Или (ЧтениеXML.Имя = "AccountingFlag" И ДанныеОбъекта.ТипОбъекта <> Перечисления.ТипыОбъектов.РегистрБухгалтерии)
					ИЛИ ЧтениеXML.Имя = "AddressingAttribute" Тогда
...
Процедура кфкПрочитатьСведенияОСвойствахИзEDT(ЧтениеXML, ДанныеОбъекта, ОбщиеПеременные)
	ТекОбъект = ДанныеОбъекта.ТекОбъект;
...
Процедура кфкЗаполнитьДанныеОбИндексированииИзXML(ЧтениеXML, ТекущееСвойство)
